...
- Add new features
- Support and improve the 1.20.1 version of LaserIO
...
- Fix various rendering errors when used with Oculus and shaders
- Better JEI dragging integration for filtering fluids and chemicals
- Change Laser Node's direction tab using the scroll wheel
- Give LaserIO 101 upon first time obtaining a Laser Node (if Patchouli is installed)
- Up to date guide book (LaserIO 101)
