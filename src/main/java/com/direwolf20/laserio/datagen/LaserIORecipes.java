...
public class LaserIORecipes extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        //Energy OverClocks
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.Stone_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Tags.Items.STONE)
                .define('p', Registration.Logic_Chip.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
                .define('g', Tags.Items.NUGGETS_GOLD)
                .group("laserio")
                .unlockedBy("has_logic_chip", InventoryChangeTrigger.TriggerInstance.hasItems(Registration.Logic_Chip.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.Flint_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Items.FLINT)
                .define('p', Registration.Stone_EOC.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
                .define('g', Tags.Items.NUGGETS_GOLD)
                .group("laserio")
                .unlockedBy("has_logic_chip", InventoryChangeTrigger.TriggerInstance.hasItems(Registration.Logic_Chip.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.Copper_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Tags.Items.INGOTS_COPPER)
                .define('p', Registration.Flint_EOC.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
                .define('g', Tags.Items.NUGGETS_GOLD)
                .group("laserio")
                .unlockedBy("has_logic_chip", InventoryChangeTrigger.TriggerInstance.hasItems(Registration.Logic_Chip.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.Iron_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Tags.Items.INGOTS_IRON)
                .define('p', Registration.Copper_EOC.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
                .define('g', Tags.Items.NUGGETS_GOLD)
                .group("laserio")
                .unlockedBy("has_logic_chip", InventoryChangeTrigger.TriggerInstance.hasItems(Registration.Logic_Chip.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.Gold_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Tags.Items.INGOTS_GOLD)
                .define('p', Registration.Iron_EOC.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
                .define('g', Tags.Items.NUGGETS_GOLD)
                .group("laserio")
                .unlockedBy("has_logic_chip", InventoryChangeTrigger.TriggerInstance.hasItems(Registration.Logic_Chip.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.Diamond_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Tags.Items.GEMS_DIAMOND)
                .define('p', Registration.Gold_EOC.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
                .define('g', Tags.Items.INGOTS_GOLD)
                .group("laserio")
                .unlockedBy("has_logic_chip", InventoryChangeTrigger.TriggerInstance.hasItems(Registration.Logic_Chip.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.Netherite_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Tags.Items.INGOTS_NETHERITE)
                .define('p', Registration.Diamond_EOC.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
                .define('g', Tags.Items.INGOTS_GOLD)
                .group("laserio")
                .unlockedBy("has_logic_chip", InventoryChangeTrigger.TriggerInstance.hasItems(Registration.Logic_Chip.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.NetherStar_EOC.get(), 1)
                .pattern("rtr")
                .pattern("rpr")
                .pattern("ggg")
                .define('t', Tags.Items.NETHER_STARS)
                .define('p', Registration.Netherite_EOC.get())
                .define('r', Tags.Items.DUSTS_REDSTONE)
