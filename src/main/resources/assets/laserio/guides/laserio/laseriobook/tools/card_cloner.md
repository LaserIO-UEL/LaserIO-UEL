...
When pasting cards, [Overclockers](../upgrades/overclocker_card.md), and [Filters](../filters/filters.md) will be automatically taken (or placed back) inside the currently available [Card Holder](card_holder.md). These items will **not** be pulled out of the player's inventory.
...
While in world, (with the Card Cloner in hand) shift+right-click on a Node to copy it. This copies all cards (settings and placement) and the network settings of the network it belongs to.
...
While **not** looking at a Node, shift+right-click will clear any stored settings from the Card Cloner.
