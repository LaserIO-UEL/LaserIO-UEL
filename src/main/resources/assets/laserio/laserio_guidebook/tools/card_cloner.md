...
While in world, (with the Card Cloner in hand) shift+right-click on a Node to copy it. This copies all Node's contents and the network settings of the network it belongs to.
