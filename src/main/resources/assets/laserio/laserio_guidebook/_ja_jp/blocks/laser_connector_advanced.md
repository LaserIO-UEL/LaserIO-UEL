...
発展レーザー中継器は<ItemLink id="laserio:laser_connector" />と同じように機能し、最大8ブロック離れた他の基本中継器又はノードに接続します。
...
<ItemLink id="laserio:laser_wrench" />を持って中継器を見るとペアリングされた中継器の座標が表示されます。
